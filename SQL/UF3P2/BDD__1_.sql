...
CREATE TABLE logistica (
	...
	CONSTRAINT fk_logistica_departament 
		FOREIGN KEY (id_departament) REFERENCES departament (id_departament),
	CONSTRAINT ck_capacitat_m3 CHECK (capacitat <= 90)
)	ENGINE=INNODB;
...
CREATE TABLE producte(
    ...
    CONSTRAINT ck_producte_preu CHECK (preu >= 5.00)
)	AUTO_INCREMENT = 1,	ENGINE=INNODB;
...
CREATE TABLE garatge (
	id_garatge SMALLINT AUTO_INCREMENT,
	numero SMALLINT NOT NULL,
	capacitat MEDIUMINT NOT NULL,
	PRIMARY KEY (id_garatge)
)	AUTO_INCREMENT = 1, ENGINE=INNODB;

CREATE TABLE porta (
	id_porta SMALLINT AUTO_INCREMENT,
	id_garatge SMALLINT NOT NULL,
	vehicle_id SMALLINT NOT NULL,
	numero SMALLINT NOT NULL,
	PRIMARY KEY (id_porta, id_garatge),
	CONSTRAINT fk_porta_garatge
		FOREIGN KEY (id_garatge) REFERENCES garatge (id_garatge),
	CONSTRAINT fk_porta_vehicle
		FOREIGN KEY (vehicle_id) REFERENCES vehicle (id_vehicle)
)	AUTO_INCREMENT = 1, ENGINE = INNODB;

CREATE TABLE proveedor (
	id_proveedor SMALLINT AUTO_INCREMENT,
	nom VARCHAR(20) NOT NULL,
	ubicacio VARCHAR(30) NOT NULL,
	PRIMARY KEY (id_proveedor)
)	AUTO_INCREMENT = 1, ENGINE = INNODB;

CREATE TABLE proveedor_producte (
	id_proveedor SMALLINT NOT NULL,
	id_producte MEDIUMINT NOT NULL,
	quantitat MEDIUMINT NOT NULL,
	PRIMARY KEY(id_proveedor, id_producte),
	CONSTRAINT fk_proveedor_producte_proveedor
		FOREIGN KEY (id_proveedor) REFERENCES proveedor (id_proveedor),
	CONSTRAINT fk_proveedor_producte_producte
		FOREIGN KEY (id_producte) REFERENCES producte (id_producte)
)	ENGINE = INNODB;
